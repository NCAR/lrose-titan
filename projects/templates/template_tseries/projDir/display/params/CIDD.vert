...
DBZ_SF_VERT  DBZ_SF_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&DBZ_F  dbz.colors     dBZ    -5   80  5  cart   1 0
DBZ_S_VERT   DBZ_S_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&DBZ    dbz.colors     dBZ    -5   80  5  cart   1 0

VEL_SF_VERT  VEL_SF_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&VEL_F  vel.colors    m/s     -5   80  5  cart   1 0
VEL_S_VERT   VEL_S_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&VEL    vel.colors    m/s     -5   80  5  cart   1 0

WIDTH_SF_VERT  WIDTH_SF_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&WIDTH_F  width.colors    m/s     -5   80  5  cart   1 0
WIDTH_S_VERT   WIDTH_S_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&WIDTH    width.colors    m/s     -5   80  5  cart   1 0

ZDR_SF_VERT   ZDR_SF_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&ZDR_F  zdr2.colors  dB      -5   80  5  radial   1 0
ZDR_S_VERT    ZDR_S_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&ZDR   zdr2.colors  dB      -5   80  5  radial   1 0

ZDRM_SF_VERT   ZDRM_SF_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&ZDRM_F  zdr2.colors  dB      -5   80  5  radial   1 0
ZDRM_S_VERT    ZDRM_S_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&ZDRM   zdr2.colors  dB      -5   80  5  radial   1 0
...
PHIDP_SF_VERT  PHIDP_SF_VERT mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&PHIDP_F phidp.colors  deg     -5   80  5  radial   1 0
PHIDP_S_VERT   PHIDP_S_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&PHIDP   phidp.colors  deg     -5   80  5  radial   1 0

RHOHV_SF_VERT  RHOHV_SF_VERT mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&RHOHV_F rhohv.colors   _     -5   80  5  radial   1 0
RHOHV_S_VERT   RHOHV_S_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&RHOHV   rhohv.colors   _     -5   80  5  radial   1 0

KDP_SF_VERT  KDP_SF_VERT  mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&KDP_F   kdp.colors   deg/km  -5   80  5  radial   1 0
KDP_S_VERT   KDP_S_VERT   mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&KDP     kdp.colors   deg/km  -5   80  5  radial   1 0

SNR_S_VERT  SNR_S_VERT mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&SNR     snr.colors    dB      -5   80  5  radial   1 0
SNR_X_VERT  SNR_X_VERT mdvp:://$(DATA_HOST):0:mdv/radarPolar/cp2_x/vert&SNR     snr.colors    dB      -5   80  5  radial   1 0

DBM_S_VERT  DBM_S_VERT mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&DBM     dbm.colors    dB      -5   80  5  radial   1 0
DBM_X_VERT  DBM_X_VERT mdvp:://$(DATA_HOST):0:mdv/radarPolar/cp2_x/vert&DBM     dbm.colors    dB      -5   80  5  radial   1 0

NCP_S_VERT   NCP_S_VERT     mdvp:://$(DATA_HOST):0:mdv/radarPolar/ops/vert&NCP   fraction.colors  dB   -5   80  5  radial   1 0
