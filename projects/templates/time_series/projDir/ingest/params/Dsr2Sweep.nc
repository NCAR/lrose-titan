...
output_dir = "$(DATA_DIR)/nc/sweep/ops";
...
//
// Option to use the fixed (target) angle in file name.
// If TRUE, the fixed angle in the center of the sweep will be used to 
//   name the file. If FALSE, the mean of the angles in the sweep will be 
//   used to name the file.
// Type: boolean
//

use_fixed_angle_for_filename = TRUE;
...
///////////// platform_name ///////////////////////////
//
// Name of instrument platform.
// This is normally the radar name, and is used in the sweep file name.
// Type: string
//
...
//
// Option to set the calibrated power as the measured power.
// If TRUE, the measured power will be stored as calibrated power.
// Type: boolean
//

set_calib_power_to_measured_power = FALSE;
